...
public class TorreTest {
	...
	private static final String COLOR_NO_NULO = "Deberia haber saltado una excepcion indicando que el color no puede ser nulo.";
	private static final String EXCEPCION_MENSAJE_ADECUADO = "Deberia haber saltado una excepcion con el mensaje adecuado.";
	private static final String ERROR_COLOR_NULO = "ERROR: No se puede asignar un color nulo.";
	private static final String OBJETO_DEBERIA_SER_NULL = "No se deberia haber creado el objeto torre.";
	private static final String NO_EXCEPCION_MOVIMIENTO_VALIDO = "No deberia saltar ninguna excepcion ya que los movimientos son validos.";	
	private static final String DIRECCION_NO_NULA = "Deberia haber saltado una excepcion indicando que no se puede mover en una direccion nula.";
	private static final String ERROR_DIRECCION_NULA = "ERROR: La direccion no puede ser nula.";
	
	private static final String PASOS_NO_POSTIVOS = "Deberia haber saltado una excepcion indicando que no se puede mover pasos no positivos.";
	private static final String CADENA_NO_ESPERADA = "La cadena devuelta no es la esperada.";
	
	
	private static final String ERROR_MOVIMIENTO_NO_VALIDO = "ERROR: Movimiento no valido (se sale del tablero).";
	private static final String ERROR_ENROQUE_NO_VALIDO = "ERROR: Movimiento de enroque no valido.";

	private static final String ERROR_PASOS_NO_POSITIVOS = "ERROR: El numero de pasos debe ser positivo.";
	private static final String ERROR_COLUMNA_NO_VALIDA = "ERROR: Columna no valida.";
	
	private static final String EXCEPCION_MOVIMIENTO_NO_VALIDO = "Deberia haber saltado una excepcion indicando que el movimiento no es valido.";
	private static final String NO_EXCEPCION = "No deberia haber saltado este tipo de excepcion.";
